...
* per capita count variables
foreach v of varlist tests cases deathsinvolvingcovid19 deaths_confirmed deathsfromallcauses admissions  {
	replace `v' = `v'/(population)
}

* Storage variables
foreach v of varlist tests positive repub  populationdensity householdsize percentlivinginpoverty percentpopulation65yrs svi ccvi pct_vax* {
...
graph export "Output/contiguous_counties_2sls_per_capita.pdf", replace
